...
hammer_img = pg.image.load("./assets/images/hammer.png")
...
debris_img = pg.image.load("./assets/images/e1.png")
debris_img = pg.transform.scale(debris_img, (debris_size, debris_size))

spike_img = pg.image.load("./assets/images/spike.png")
spike_img = pg.transform.scale(spike_img, (spike_size, spike_size))

blue_mushroom_img = pg.image.load("./assets/images/blue_mushroom.png")
blue_mushroom_img = pg.transform.scale(blue_mushroom_img, (blue_mushroom_size, blue_mushroom_size))

red_mushroom_img = pg.image.load("./assets/images/red_mushroom.png")
    ...
    while running:
        ...
        if state == 1:
            ...
            if is_small and pg.time.get_ticks() - small_timer > 3000:
                player_size = 40
                player_img = pg.transform.scale(pg.image.load("./assets/images/mario.png"), (player_size, player_size))
                is_small = False
